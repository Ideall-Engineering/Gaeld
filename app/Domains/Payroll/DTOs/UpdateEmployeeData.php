...
readonly class UpdateEmployeeData
{
    ...
    public function __construct(
        ...
        public ?string $employmentRate = null,
        public ?string $expenseAllowance = null,
        public string $salaryType = 'monthly',
        public ?string $hourlyRate = null,
        public ?string $vacationCompensationRate = null,
        public ?string $thirteenthCompensationRate = null,
    ...
    public static function fromArray(array $data): self
    {
        ...
        return new self(
            ...
            city: $data['city'] ?? null,
            placeOfOrigin: $data['place_of_origin'] ?? null,
            jobTitle: $data['job_title'] ?? null,
            employmentRate: isset($data['employment_rate']) ? (string) $data['employment_rate'] : null,
            expenseAllowance: isset($data['expense_allowance']) ? (string) $data['expense_allowance'] : null,
            salaryType: ($data['salary_type'] ?? 'monthly') === 'hourly' ? 'hourly' : 'monthly',
            hourlyRate: isset($data['hourly_rate']) ? (string) $data['hourly_rate'] : null,
            vacationCompensationRate: isset($data['vacation_compensation_rate']) ? (string) $data['vacation_compensation_rate'] : null,
            thirteenthCompensationRate: isset($data['thirteenth_compensation_rate']) ? (string) $data['thirteenth_compensation_rate'] : null,
            iban: $data['iban'] ?? null,
